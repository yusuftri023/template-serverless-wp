...
class Helper
{
    use \WeddingPress\Trait_Plugin;
    use \WeddingPress\Trait_FileSystem;
    use \WeddingPress\Trait_WP;
    use \WeddingPress\Trait_Meta;
    use \WeddingPress\Trait_Elementor;
    use \WeddingPress\Trait_Form;
    use \WeddingPress\Trait_String;
    use \WeddingPress\Trait_Image;
    use \WeddingPress\Navigation;
    use \WeddingPress\Trait_Notice;
    use \WeddingPress\Trait_Static;
    use \WeddingPress\Trait_Date;
